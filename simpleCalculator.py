...
mainframe=Frame(window,width=45,bd=10,relief=RIDGE,bg='black')
mainframe.pack()
...
button_add=Button(inner,text='+',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=add)
button_sub=Button(inner,text='-',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=sub)
button_div=Button(inner,text='/',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=div)
button_mul=Button(inner,text='*',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=mul)
button_clear=Button(inner,text='C',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=clear)
button_equal=Button(inner,text='=',padx=30,pady=10,font='15',relief=RIDGE,width=4,command=equal)
